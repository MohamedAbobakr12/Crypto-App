...
const Features = () => {
    return (
        <section className="flex flex-col bg-black h-max" id="pages">
            <div className="flex flex-col gap-y-20 max-w-5xl lg:px-4 mx-auto mt-36 max-md:mt-18">
                <div className="flex gap-x-20 max-xl:gap-x-10 max-lg:gap-x-8 max-md:flex-col md:justify-around mx-auto">
                ...
                <div className="flex max-md:flex-col  gap-x-20 max-xl:gap-x-16 md:justify-around mx-auto xl:px-5">
                    ...
                    <div className="flex flex-col max-md:self-center max-lg:items-center max-lg:w-[25rem] max-md:w-[20rem]">
                        ...
                        <div className="flex max-lg:flex-col max-lg:gap-y-6 max-md:gap-y-8 items-center mt-10">
